...
def build_solved_candidate(candidate, graph, P_pred, aux_pred, idx=0):
    ...
    out["dtg_solver_debug"] = {
        "candidate_id": cid,
        "solver_type": "dtg_transformer_v4_junction_anchor_safe",
        "num_nodes": int(N),
...
def main():
    ...
    print("\n" + "=" * 80)
    print("DTG-Transformer v4 Inference Safe")
    ...
    output_obj = {
        "schema_version": "solved_glyph_candidates_dtg_transformer_v4_safe_inference",
        "solver_type": "dtg_transformer_v4_junction_anchor_safe",
    ...
    report_obj = {
        "schema_version": "dtg_transformer_v4_safe_inference_report",
        "solver_type": "dtg_transformer_v4_junction_anchor_safe",
        "summary": summary,
        "model_info": model_info,
