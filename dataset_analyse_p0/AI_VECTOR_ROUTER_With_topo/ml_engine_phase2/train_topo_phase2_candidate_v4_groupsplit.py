# -*- coding: utf-8 -*-
"""
train_topo_phase2_candidate_v4_groupsplit.py

位置建议：
    Babel_Simulater/dataset_analyse_p0/AI_VECTOR_ROUTER_With_topo/ml_engine_phase2/train_topo_phase2_candidate_v4_groupsplit.py
...
class Cfg:
    ...
    best_name: str = "topo_phase2_candidate_v4_best_loss.pth"
    best_f1_name: str = "topo_phase2_candidate_v4_best_candidate_f1.pth"
    latest_name: str = "topo_phase2_candidate_v4_latest.pth"
