# -*- coding: utf-8 -*-
"""
action_stage2_preview_tool.py

Phase 2 拓扑标注结果 Preview Tool。
...
class Phase2PreviewWorkspace(QWidget):
    ...
    def _init_ui(self):
        ...
        title = QLabel(f"✅  Phase 2 Topo Annotations for: {self.font_name}")
    ...
    def _load_gallery(self):
        ...
        for idx, hex_key in enumerate(keys):
            ...
            info_lbl   = QLabel(f"Strokes:{stroke_cnt}  Edits:{edit_cnt}")
    ...
    def _open_timeline(self, hex_key: str):
        ...
        lbl_title = QLabel(f"Phase 2 Audit Trail: '{char_str}'  ({hex_key})")
...
class PreviewAppMain(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Phase 2 Topo Annotation Auditor")
