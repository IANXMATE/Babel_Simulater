# -*- coding: utf-8 -*-
r"""
train_flywheel_topohgt_v7_stage1_topologyonly_ckptselect.py

建议放置位置：
    dataset_analyse_p0/Char_Glyph_v0/flywheel_model/train_flywheel_topohgt_v7_stage1_topologyonly_ckptselect.py
...
class Cfg:
    ...
    num_workers: int = 0
    log_every: int = 5
    save_prefix: str = "flywheel_topohgt_v7_stage1_topologyonly_ckptselect"
...
def cache_signature(records, cfg):
    payload = {
        "script": "train_flywheel_topohgt_v7_stage1_topologyonly_ckptselect",
...
def train():
    ...
    print("=" * 88)
    print("[FlywheelTopoHGT-v7-stage1-topologyonly-ckptselect] start")
