# -*- coding: utf-8 -*-
r"""
train_flywheel_topohgt_v6_relationcalib.py

建议放置位置：
    dataset_analyse_p0/Char_Glyph_v0/flywheel_model/train_flywheel_topohgt_v6_relationcalib.py
...
class Cfg:
    ...
    num_workers: int = 0
    log_every: int = 5
    save_prefix: str = "flywheel_topohgt_v6_relationcalib"
...
def cache_signature(records, cfg):
    payload = {
        "script": "train_flywheel_topohgt_v6_relationcalib",
...
def train():
    ...
    print("=" * 88)
    print("[FlywheelTopoHGT-v6-relationcalib] start")
