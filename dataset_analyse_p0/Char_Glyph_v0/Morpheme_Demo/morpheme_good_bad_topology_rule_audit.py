# -*- coding: utf-8 -*-
r'''
morpheme_good_bad_topology_rule_audit.py

放置位置建议：
    dataset_analyse_p0/Char_Glyph_v0/Morpheme_Demo/morpheme_good_bad_topology_rule_audit.py

运行：
    cd dataset_analyse_p0/Char_Glyph_v0/Morpheme_Demo
    python morpheme_good_bad_topology_rule_audit.py
...
OUTPUT_DIR = SCRIPT_DIR / 'rule_audit_outputs'
...
def main():
    parser = argparse.ArgumentParser(description='Audit Good/Bad/Manual topology samples for independent rule design.')
    ...
    t0 = time.time()
    rep = Reporter()
    rep.section('Morpheme Good/Bad Topology Rule Audit')
    ...
    txt_path = OUTPUT_DIR / 'topology_rule_audit_report.txt'
    json_path = OUTPUT_DIR / 'topology_rule_audit_summary.json'
