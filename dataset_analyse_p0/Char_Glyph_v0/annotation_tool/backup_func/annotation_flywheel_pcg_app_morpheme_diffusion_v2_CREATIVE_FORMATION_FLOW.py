...
class AnnotationFlywheelPCGNoJSONApp:
    ...
    def _build_ui(self):
        ...
        ttk.Label(row4d, text="Creative Formation-Flow:").pack(side="left", padx=(8, 2))
        ttk.Checkbutton(row4d, text="递归构成流场", variable=self.use_creative_formation_flow_var).pack(side="left", padx=6)
