# -*- coding: utf-8 -*-
r"""
annotation_flywheel_pcg_app_no_json_v8_fast_x_stable_local_pool_legacy_loader.py
            ...
            if (not PRESERVE_STAGE2_BUNDLE) and isinstance(bundle, dict):
                ...
                if isinstance(bundle["edit_history"], list):
                    bundle["edit_history"].append({
                        ...
                        "timestamp": time.strftime("%Y-%m-%d %H:%M:%S"),
                        "source": "annotation_flywheel_pcg_app_no_json_v8_fast_x_stable_local_pool_legacy_loader.py",
                    })
